...
const (
	UserUrn                    = "urn:ietf:params:scim:schemas:core:2_0:User"
	AccountPasswordUrn         = "urn:ietf:params:scim:schemas:extension:account:2_0:Password"
	PasswordPolicyUrn          = "urn:ietf:params:scim:schemas:core:2_0:policy:Password"
	PasswordResetRequestUrn    = "urn:ietf:params:scim:schemas:core:2_0:password:PasswordResetRequest"
	PasswordValidateRequestUrn = "urn:ietf:params:scim:schemas:core:2_0:password:PasswordValidateRequest"
	EnterpriseUserUrn          = "urn:ietf:params:scim:schemas:extension:enterprise:2_0:User"
	GroupUrn                   = "urn:ietf:params:scim:schemas:core:2_0:Group"
	ResourceTypeUrn            = "urn:ietf:params:scim:schemas:core:2_0:resourceType"
	SPConfigUrn                = "urn:ietf:params:scim:schemas:core:2_0:ServiceProviderConfig"
	SchemaUrn                  = "urn:ietf:params:scim:schemas:core:2_0:Schema"
	ErrorUrn                   = "urn:ietf:params:scim:api:messages:2_0:Error"
	ListResponseUrn            = "urn:ietf:params:scim:api:messages:2_0:ListResponse"
	PatchOpUrn                 = "urn:ietf:params:scim:api:messages:2_0:PatchOp"
	SearchUrn                  = "urn:ietf:params:scim:api:messages:2_0:SearchRequest"
	BulkRequestUrn             = "urn:ietf:params:scim:api:messages:2_0:BulkRequest"
	BulkResponseUrn            = "urn:ietf:params:scim:api:messages:2_0:BulkResponse"
	...
	PasswordPolicyResourceType        = "PasswordPolicy"
