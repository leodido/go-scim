...
const (
	...
	AccountPasswordUrn         = "urn:ietf:params:scim:schemas:extension:account:2.0:Password"
	PasswordPolicyUrn          = "urn:ietf:params:scim:schemas:core:2.0:policy:Password"
	PasswordResetRequestUrn    = "urn:ietf:params:scim:schemas:core:2.0:password:PasswordResetRequest"
	PasswordValidateRequestUrn = "urn:ietf:params:scim:schemas:core:2.0:password:PasswordValidateRequest"
