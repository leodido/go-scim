	...
	for _, test := range []struct {
		...
		},
		{
			func() (interface{}, string) {
				...
				require.Nil(t, err)
				require.NotNil(t, r)
				return r, `{"schemas": ["urn:ietf:params:scim:schemas:core:2_0:User"], "id": "6B69753B-4E38-444E-8AC6-9D0E4D644D80"}`
			},
			[]string{"id"},
			nil,
		},
		{
			func() (interface{}, string) {
				...
				require.Nil(t, err)
				require.NotNil(t, r)
				return r, `{"schemas": ["urn:ietf:params:scim:schemas:core:2_0:User"], "id": "6B69753B-4E38-444E-8AC6-9D0E4D644D80", "userName": "david@example.com"}`
			},
			nil,
			[]string{
				"schemas",
		...
		},
		{
			func() (interface{}, string) {
				...
				json := `
				{
					"schemas": ["urn:ietf:params:scim:api:messages:2_0:ListResponse"],
					"totalResults": 100,
					"itemsPerPage": 10,
					"startIndex": 1,
					"Resources": [
						{
							"schemas": ["urn:ietf:params:scim:schemas:core:2_0:User"],
